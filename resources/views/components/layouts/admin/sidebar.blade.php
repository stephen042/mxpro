    ...
    <flux:sidebar sticky stashable class="border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Overview')" class="grid">
                ...
                <flux:navlist.item icon="wallet" :href="route('admin.wallet.address')" :current="request()->routeIs('admin.wallet.address')"
                    wire:navigate>{{ __('Wallet Addresses') }}</flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
        ...
        <flux:dropdown position="bottom" align="start">
            ...
            <flux:menu class="w-[220px]">
                ...
                <!-- Updated to use admin settings route -->
                <flux:menu.radio.group>
                    <flux:menu.item :href="route('admin.settings.profile')" icon="cog" wire:navigate>{{ __('Settings') }}
                    </flux:menu.item>
                </flux:menu.radio.group>
