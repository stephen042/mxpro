        ...
        <div>
            ...
            <div class="flex">
                <input type="email" readonly value="{{ $user->email }}"
                    class="flex-1 px-1 py-2 border border-gray-300 dark:border-gray-600 rounded-l-md bg-gray-50 dark:bg-gray-600 text-gray-700 dark:text-gray-200">
                <a href="mailto:{{ $user->email }}"
                    class="flex items-center justify-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-r-md">
