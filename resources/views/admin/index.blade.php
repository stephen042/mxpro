    ...
    <div class="container mx-auto space-y-6">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white dark:bg-gray-900 shadow rounded-lg p-5 flex flex-col items-center">
                    <svg class="w-10 h-10 text-yellow-500 dark:text-yellow-300" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                ...
                <div class="bg-white dark:bg-gray-900 shadow rounded-lg p-5 flex flex-col items-center">
                    <svg class="w-10 h-10 text-red-500 dark:text-red-300" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
